...
import com.example.lq.light_life.ui.fragment.LightLifeFrag;
import com.example.lq.light_life.ui.fragment.MainHomeFrag;
import com.example.lq.light_life.ui.fragment.MineFrag;
...
//        fragmentTabHost.getTabWidget().getChildTabViewAt(1).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                mTableItemList.get(1).getFragmentClass();
//            }
//        });
    }
    ...
    private void initTabData() {
        ...
        //添加tab
        mTableItemList.add(new TabItem(R.drawable.home,R.drawable.home_selected,R.string.main_home_text, MainHomeFrag.class));
        mTableItemList.add(new TabItem(R.drawable.light_life,R.drawable.light_life_selected,R.string.main_light_life_text, LightLifeFrag.class));
        mTableItemList.add(new TabItem(R.drawable.user,R.drawable.user_selected,R.string.main_mine_text, MineFrag.class));
    ...
    class TabItem {
        ...
        public void setChecked(boolean isChecked) {
            ...
            if(textView != null && title != 0) {
                if(isChecked) {
                    textView.setTextColor(getResources().getColor(R.color.essence_tab_text_color_press));
                } else {
                    textView.setTextColor(getResources().getColor(R.color.essence_tab_text_color_normal));
                }
            }
        }
    }
