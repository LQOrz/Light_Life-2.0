package com.example.lq.light_life.ui.widget.floatingactionbutton;
...
public class MultiFloatingActionButton extends ViewGroup {
    ...
    private void getAttributes(Context context, AttributeSet attrs){
        ...
        mBackgroundColor = typedArray.getColor(
                R.styleable.MultiFloatingActionButton_backgroundColor, Color.parseColor("#08BEFF"));
    ...
    private void setBaseViews(Context context){
        ...
        mBackgroundView.setFitsSystemWindows(true);
    ...
    private void changeBackground(){
        ObjectAnimator animator = isMenuOpen ? ObjectAnimator.ofFloat(mBackgroundView, "alpha", 0.5f, 0f) :
                ObjectAnimator.ofFloat(mBackgroundView, "alpha", 0f, 0.5f);
        animator.setDuration(150);
        animator.setInterpolator(new LinearInterpolator());
        animator.start();
    }
